# app.py
"""
Aplikasi Peta Digital Lokasi UMKM / Kampus untuk Streamlit
Fitur:
- Upload CSV (kolom minimal: name,type,latitude,longitude,description[opsional])
- Gunakan sample data bila belum upload
- Filter berdasarkan type (UMKM / Kampus / Semua)
- Pencarian nama lokasi
- Tambah lokasi manual
- Visualisasi peta dengan Folium (marker + popup)
- Visualisasi clustering KMeans (sebagai penerapan ML ringan)
- Tabel data & download CSV
- Siap di-deploy ke Streamlit Cloud
"""
...
def make_sample_data():
    data = [
        {"name":"Warung Maju","type":"UMKM","latitude":-6.914744,"longitude":107.609810,"description":"Warung dekat kampus A"},
        {"name":"Toko Serba Ada","type":"UMKM","latitude":-6.917464,"longitude":107.619123,"description":"Toko kelontong"},
        {"name":"Kampus Utama","type":"Kampus","latitude":-6.922000,"longitude":107.610000,"description":"Kampus negeri"},
        {"name":"Kantin Kampus","type":"UMKM","latitude":-6.920500,"longitude":107.612345,"description":"Kantin dalam area kampus"},
        {"name":"Cozy Cafe","type":"UMKM","latitude":-6.916700,"longitude":107.613200,"description":"Kafe kecil"},
        {"name":"Politeknik X","type":"Kampus","latitude":-6.925000,"longitude":107.606000,"description":"Politeknik"},
        {"name":"Bakery Roti","type":"UMKM","latitude":-6.918800,"longitude":107.615000,"description":"Toko roti"},
        {"name":"Studio Fotografi","type":"UMKM","latitude":-6.913200,"longitude":107.611900,"description":"Jasa foto"},
    ]
